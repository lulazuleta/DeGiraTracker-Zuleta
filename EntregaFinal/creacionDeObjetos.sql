...
SELECT 
    tk.usuario_asignado AS id_usuario, usu.usuario,
    AVG(tiempo_trabajado) AS tiempo_promedio_trabajado
FROM tickets tk
INNER JOIN usuarios usu
ON usu.id_usuario = tk.usuario_asignado
GROUP BY usuario_asignado
...
-- estado actual del backlog de cada proyecto tickets por estado, por proyecto, sla vencido 
